...
class MainWindow : public QMainWindow {
 ...
 private slots:
  ...
  /**
   * @brief Generates a diffuse irradiance texture from the loaded specular cubemap
   */
  void on_actionGenerate_Diffuse_Irradiance_triggered();

   /**
   * @brief Generates a specular irradiance texture from the loaded specular cubemap
   */
  void on_actionGenerate_Specular_Irradiance_triggered();
