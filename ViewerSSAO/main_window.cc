...
void MainWindow::on_actionGenerate_Diffuse_Irradiance_triggered() {
  ui -> glwidget -> GenerateDiffuseIrradiance();
}

void MainWindow::on_actionGenerate_Specular_Irradiance_triggered() {
  ui -> glwidget -> GenerateSpecularIrradiance();
